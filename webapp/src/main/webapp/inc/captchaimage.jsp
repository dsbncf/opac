...
<%
  ...
  /* font style */
  Font fntStyle1 = new Font("Arial", Font.BOLD, 15);
  ...
  { 
    ...
    g2dImage.setColor(new Color(randChars.nextInt(255),randChars.nextInt(255),randChars.nextInt(255)));
    if (i%2==0) 
      g2dImage.drawString(sImageCode.substring(i,i+1),20*i,14); 
    else 
      g2dImage.drawString(sImageCode.substring(i,i+1),20*i,17); 
  } 
  ...
  session.setAttribute("CAPTCHA", sImageCode); 
  
  //System.out.println("img:" + session.getAttribute("CAPTCHA"));
